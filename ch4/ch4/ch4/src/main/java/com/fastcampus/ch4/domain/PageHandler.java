...
public class PageHandler {
	...
	private int totalPage; 		// 페이지 내비게이션의 크기
	private int	page;			// 현재 페이지
	private int	beginPage;		// 현재 페이지
	private int	endPage;		// 현재 페이지
	private boolean showPrev;	// 이전 페이지로 이동하는 링크를 보여줄 것 인지의 여부
	private boolean showNext;	// 다음 페이지로 이동하는 링크를 보여줄 것 인지의 
